...
export const init = () => {
  ...
  if (!fs.existsSync(BOOKING_DB_PATH)) {
    logger.info(
      "The database for the Booking module was not found. Creating...",
    );
  ...
  if (!fs.existsSync(MONITORING_DB_PATH)) {
    logger.info(
      "The database for the Monitoring module was not found. Creating...",
    );
  ...
  if (!fs.existsSync(VERION_STORAGE_DB_PATH)) {
    logger.info(
      "The database for the VersionStorage feature of Booking module was not found. Creating...",
    );
